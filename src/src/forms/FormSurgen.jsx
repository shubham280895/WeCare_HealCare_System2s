...
export default function FormSurgen({ dataItem, select, pData }) {
    ...
    async function handelSubmit(params) {
        if (!time || !prescription || !billAmount) {
            const newErrors = {};
        ...
        try {
            ...
            formData.append("surgeryTime", time + ':00');
    ...
    return (
        <> <div className="header-menu">
            ...
            <div className="form-field-container-r">
                ...
                <div className="data-field">
                    <div>Time :</div>
                    <div><input type="time" name="time" className='input-box' value={time} onChange={(e) => setTime(e.target.value)} /></div>
                </div>
